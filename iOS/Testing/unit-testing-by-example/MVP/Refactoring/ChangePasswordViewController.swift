...
class ChangePasswordViewController: UIViewController {
    ...
    */
    ...
    @IBAction private func changePassword() {
        ...
        passwordInputs.oldPassword = oldPasswordTextField.text ?? ""
        passwordInputs.newPassword = newPasswordTextField.text ?? ""
        passwordInputs.confirmPassword = confirmPasswordTextField.text ?? ""
        */
